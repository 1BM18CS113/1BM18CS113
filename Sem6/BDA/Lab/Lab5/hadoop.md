...
- Check version
```
sumanth@debian:~$ hadoop version
Hadoop 3.3.0
Source code repository https://gitbox.apache.org/repos/asf/hadoop.git -r aa96f1871bfd858f9bac59cf2a81ec470da649af
Compiled by brahma on 2020-07-06T18:44Z
Compiled with protoc 3.7.1
From source with checksum 5dc29b802d6ccd77b262ef9d04d19c4
This command was run using /opt/sumanth/hadoop/share/hadoop/common/hadoop-common-3.3.0.jar
```

- List files
```
sumanth@debian:~$ hadoop fs -ls /
Found 2 items
...
- Create dir
```
sumanth@debian:~$ hadoop fs -mkdir /sample
...
```
sumanth@debian:~$ touch a.txt
sumanth@debian:~$ ls
apps  a.txt  sumanth_credentials  htdocs  stack
sumanth@debian:~$ hadoop fs -put ~/a.txt /sample/a.txt         
sumanth@debian:~$ hadoop fs -ls /sample
Found 1 items
...
```
sumanth@debian:~$ hadoop fs -get /sample/a.txt ~/a-fromHDFS.txt
sumanth@debian:~$ ls
a-fromHDFS.txt  apps  a.txt  sumanth_credentials  htdocs  stack
```

- Copy local file to HDFS using copyFromLocal
```
sumanth@debian:~$ hadoop fs -copyFromLocal ~/a.txt /sample/a-copyfromlocal.txt
sumanth@debian:~$ hadoop fs -ls /sample
Found 2 items
...
```
sumanth@debian:~$ hadoop fs -copyToLocal /sample/a.txt ~/a-copytolocal.txt
sumanth@debian:~$ ls
a-copytolocal.txt  apps  sumanth_credentials  htdocs  stack
```

- Display contents of HDFS file in console
```
sumanth@debian:~$ hadoop fs -cat /sample/b.txt
hi how are you
how is your job
how is your family
how is your brother
...
```
sumanth@debian:~$ hadoop fs -mkdir /sample-copy
sumanth@debian:~$ hadoop fs -cp /sample/b.txt /sample-copy/b.txt
sumanth@debian:~$ hadoop fs -ls /sample-copy
Found 1 items
...
drwxrwxrwt   - hadoop supergroup          0 2021-01-28 07:16 /tmp
drwxr-xr-x   - hadoop supergroup          0 2021-01-28 07:16 /user
sumanth@debian:~$ hadoop fs -rm -r -f /sample-copy
Deleted /sample-copy
```
